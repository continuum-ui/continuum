    ...
    viteFinal: async (config) => {
        ...
        if (config.resolve) {
            config.resolve.alias = {
                ...
                "@continuum-ui/components": join(__dirname, "../../../packages/components/src"),
                "@continuum-ui/themes": join(__dirname, "../../../packages/themes"),
                "@continuum-ui/tokens": join(__dirname, "../../../packages/tokens/dist"),
